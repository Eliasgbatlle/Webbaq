...
export function DevelopersSection() {
  ...
  return (
    <section id="developers" ref={sectionRef} className="relative py-24 lg:py-32 overflow-x-clip">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="lg:order-1">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-display tracking-tight leading-[1.1]">
                Diseño profesional.
                <br />
          ...
          {/* iPhone Scene */}
          <div className="lg:order-2 relative h-[500px] lg:h-[650px] -mx-6 sm:mx-0 lg:-mr-32">
